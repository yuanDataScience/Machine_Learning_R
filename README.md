...
1. prepend the original github URL by http://htmlpreview.github.com/. For example, to see the LinearRegress.nb.html in the Ex1 folder of this repo, use the following link:           
